...
import { isAuthenticated, signIn, validateCredentials } from "@/lib/auth";
...
function LoginPage() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (validateCredentials(trimmed, password)) {
      signIn(trimmed);
      router.invalidate();
        ...
        <aside className="relative hidden flex-col justify-between bg-gradient-to-b from-[#69baa7] via-[#4aa590] to-[#2f8f7b] p-10 text-white md:flex">
          ...
          <div className="relative">
            ...
            <p className="mt-3 max-w-sm text-sm leading-relaxed text-white/85">
              Sign in to continue to the Movement Intelligence Platform — your
          ...
          <div className="relative mt-10">
            ...
            <p className="mt-2 text-xs text-white/65">
              Secure admin access · Internal tooling
            </p>
          </div>
        </aside>
