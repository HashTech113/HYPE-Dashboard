      ...
      <DialogContent className="max-w-lg rounded-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            <Field label="RTSP path" required className="sm:col-span-2">
              <Input
                value={form.rtsp_path}
                onChange={(e) => updateField("rtsp_path")(e.target.value)}
                placeholder={DEFAULT_RTSP_PATH}
          ...
          <div className="rounded-xl bg-slate-50 px-3 py-2.5 text-xs">
            <div className="text-slate-500">RTSP URL preview</div>
            <div className="mt-1 break-all font-mono text-slate-700">{buildRtspPreview(form)}</div>
          </div>
          ...
          <DialogFooter className="gap-2 pt-2 sm:gap-2">
            ...
            <Button
              ...
              className="h-10 rounded-xl bg-gradient-to-r from-[#4aa590] to-[#2f8f7b] px-5 text-white hover:from-[#3f9382] hover:to-[#256f60]"
            >
