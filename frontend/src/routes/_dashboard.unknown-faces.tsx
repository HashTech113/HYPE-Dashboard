...
import type { UnknownClusterStatus } from "@/lib/types/unknowns";
      ...
      <SectionShell
        ...
        actions={
          <div className="flex w-full flex-wrap items-center gap-2 md:w-auto md:gap-3">
            ...
            <Input
              value={labelQuery}
              onChange={(e) => { setLabelQuery(e.target.value); setPage(0); }}
            ...
            <div className="flex items-center gap-2 text-xs text-muted-foreground">
              ...
              <span>{total} cluster{total === 1 ? "" : "s"}</span>
            </div>
            <Button
              type="button"
              variant="outline"
