...
export function ClusterCard({ cluster, onOpen }: Props) {
  ...
  return (
    <button
      ...
      className={cn(
        "group flex flex-col overflow-hidden rounded-xl border border-rose-200/60 bg-slate-900 text-left shadow-sm transition-shadow hover:shadow-md focus:outline-none focus:ring-2 focus:ring-rose-400",
      )}
    >
      ...
      <div className="flex flex-col gap-1 bg-slate-950/90 px-3 py-2">
